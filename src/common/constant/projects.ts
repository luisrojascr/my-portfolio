...
export const PROJECTS: ProjectItemProps[] = [
  ...
  },
  {
    title: 'Vanity Spa',
    slug: 'vanity-spa',
    description: "This application, specifically designed for my wife's spa, streamlines the booking process. It efficiently integrates data from the Setmore API, optimizing appointment scheduling and management.",
    image: '/images/projects/portfolio-vanityspa.png',
    link_demo: 'https://vanityspacostarica.com/',
    link_github: '',
    stacks: '["WordPress", "PHP", "HTML", "CSS"]',
    content: "It's WordPress powered website for my wife's spa. I modified some features of the original WordPress theme.",
    is_show: true,
    is_featured: false,
